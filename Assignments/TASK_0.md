...
`La fonction responsable de gérer les inputs du programme : `
`Pour ajouter un avion il faut appuyer sur la touche :  `
`Pour quitter le programme il faut appuyer sur la touche :  `
`La touche F sert à  `
